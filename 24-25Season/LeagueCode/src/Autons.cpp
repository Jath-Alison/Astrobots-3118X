...
void blueRushAWP()
{
    ...
    doinkerDeployL.set(true);//converted from doinker clamp

    smartDrive.driveForPID(art::Inches(-48));
    smartDrive.turnToPID(art::Degrees(180));

    doinkerDeployL.set(false);//converted from doinker clamp
    smartDrive.driveForPID(art::Inches(-5));
    doinkerDeployR.set(false);
...
std::vector<Jath::Point> ringRushBluePoints = {Jath::Point(114.638, 88.811, 9), Jath::Point(112.639, 88.768, 89.811), Jath::Point(110.639, 88.74, 89.41), Jath::Point(108.639, 88.727, 88.992), Jath::Point(106.639, 88.729, 88.556), Jath::Point(104.639, 88.749, 87.631), Jath::Point(102.639, 88.787, 87.141), Jath::Point(100.64, 88.845, 86.634), Jath::Point(98.642, 88.921, 86.11), Jath::Point(96.644, 89.019, 85.568), Jath::Point(94.648, 89.137, 85.01), Jath::Point(92.653, 89.278, 84.436), Jath::Point(90.659, 89.443, 83.847), Jath::Point(88.669, 89.635, 82.63), Jath::Point(86.681, 89.854, 82.005), Jath::Point(84.696, 90.098, 81.372), Jath::Point(82.715, 90.374, 80.09), Jath::Point(80.739, 90.681, 79.446), Jath::Point(78.767, 91.018, 78.805), Jath::Point(76.803, 91.392, 77.545), Jath::Point(74.844, 91.799, 76.934), Jath::Point(72.895, 92.245, 75.772), Jath::Point(70.954, 92.727, 74.72), Jath::Point(69.024, 93.252, 74.248), Jath::Point(67.105, 93.816, 73.437), Jath::Point(65.199, 94.42, 73.109), Jath::Point(63.307, 95.07, 72.63), Jath::Point(61.431, 95.762, 72.416), Jath::Point(59.57, 96.496, 72.498), Jath::Point(57.727, 97.272, 72.897), Jath::Point(55.902, 98.09, 73.622), Jath::Point(54.096, 98.949, 74.109), Jath::Point(52.309, 99.847, 75.323), Jath::Point(50.541, 100.781, 76.846), Jath::Point(48.791, 101.749, 78.652), Jath::Point(47.058, 102.747, 80.706), Jath::Point(45.341, 103.773, 82.967), Jath::Point(43.638, 104.822, 85.389), Jath::Point(41.947, 105.89, 87.925), Jath::Point(40.267, 106.975, 90.525), Jath::Point(38.594, 108.071, 93.142), Jath::Point(36.926, 109.175, 95.73), Jath::Point(35.261, 110.282, 97.753), Jath::Point(33.596, 111.39, 95.346), Jath::Point(31.928, 112.494, 93.081), Jath::Point(30.256, 113.592, 90.988), Jath::Point(28.578, 114.679, 89.088), Jath::Point(26.891, 115.754, 87.4), Jath::Point(25.195, 116.814, 85.935), Jath::Point(23.488, 117.856, 85.289), Jath::Point(21.769, 118.878, 84.169), Jath::Point(20.037, 119.879, 83.28), Jath::Point(18.293, 120.858, 82.613), Jath::Point(16.536, 121.813, 82.361), Jath::Point(14.765, 122.742, 82.01), Jath::Point(12.981, 123.647, 81.849), Jath::Point(11.185, 124.525, 81.835), Jath::Point(9.375, 125.378, 81.926), Jath::Point(7.554, 126.204, 82.027), Jath::Point(5.721, 127.003, 82.324), Jath::Point(3.876, 127.776, 82.516), Jath::Point(2.022, 128.525, 82.972), Jath::Point(0.156, 129.246, 83.232), Jath::Point(-1.955, 130.031, 83.50), Jath::Point(-1.955, 130.031, 0), 
};
