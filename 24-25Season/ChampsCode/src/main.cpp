...
int main()
{
    ...
    <root>
      <shades>
        <screen id="home">
          <box_ id="box" x="0" y="0" width="480" height="240" callback="" color="0x4287F5FF"/>
          <text id="title" x="15" y="15" text="3118B - Astrobots" color="0xD07F07" bkgColor="0x4287F5FF" />
          <tex_t id="title2" x="15" y="105" text="Shades" color="0xFF0000" bkgColor="0x4287F5FF" font="prop60" />
