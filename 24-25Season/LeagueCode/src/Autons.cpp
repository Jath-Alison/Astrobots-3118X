...
std::vector<Jath::Point> pickup1Points = {
    ...
    Jath::Point(-175.185, 1.504, 120),
    Jath::Point(-173.547, 2.652, 120),
    Jath::Point(-171.934, 3.833, 120),
    Jath::Point(-170.348, 5.052, 120),
    Jath::Point(-168.79, 6.306, 120),
    Jath::Point(-167.266, 7.601, 120),
    Jath::Point(-165.776, 8.935, 120),
    Jath::Point(-164.323, 10.31, 120),
    Jath::Point(-162.911, 11.726, 120),
    Jath::Point(-161.543, 13.184, 120),
    Jath::Point(-160.221, 14.685, 120),
    Jath::Point(-158.948, 16.227, 120),
    Jath::Point(-157.725, 17.81, 120),
    Jath::Point(-156.553, 19.43, 120),
    Jath::Point(-155.431, 21.085, 120),
    Jath::Point(-154.359, 22.774, 120),
    Jath::Point(-153.334, 24.491, 120),
    Jath::Point(-152.35, 26.233, 120),
    Jath::Point(-151.403, 27.994, 120),
    Jath::Point(-150.483, 29.77, 120),
    Jath::Point(-149.581, 31.555, 120),
    Jath::Point(-148.687, 33.344, 120),
    Jath::Point(-147.788, 35.131, 120),
    Jath::Point(-146.871, 36.908, 120),
    Jath::Point(-145.923, 38.669, 120),
    Jath::Point(-144.932, 40.406, 120),
    Jath::Point(-143.888, 42.112, 120),
    Jath::Point(-142.777, 43.775, 120),
    Jath::Point(-141.597, 45.389, 120),
    Jath::Point(-140.343, 46.947, 120),
    Jath::Point(-139.013, 48.44, 120),
    Jath::Point(-137.61, 49.866, 120),
    Jath::Point(-136.138, 51.219, 120),
    Jath::Point(-134.602, 52.5, 120),
    Jath::Point(-133.01, 53.71, 120),
    Jath::Point(-131.368, 54.851, 120),
    Jath::Point(-129.681, 55.925, 120),
    Jath::Point(-127.956, 56.937, 120),
    Jath::Point(-126.198, 57.89, 120),
    Jath::Point(-124.411, 58.789, 120),
    Jath::Point(-122.601, 59.639, 120),
    Jath::Point(-120.768, 60.44, 120),
    Jath::Point(-118.918, 61.2, 120),
    Jath::Point(-117.052, 61.919, 120),
    Jath::Point(-115.173, 62.603, 120),
    Jath::Point(-113.281, 63.251, 120),
    Jath::Point(-111.182, 63.933, 12),
    Jath::Point(-111.182, 63.933, 0),
};
Jath::Path pickup1Path = Jath::Path::cm(pickup1Points);

std::vector<Jath::Point> rings1Points = {
    Jath::Point(-118.786, 57.416, 95.04),
    Jath::Point(-117.846, 59.182, 94.872),
    Jath::Point(-116.897, 60.942, 94.503),
    Jath::Point(-115.936, 62.696, 94.312),
    Jath::Point(-114.963, 64.444, 93.914),
    Jath::Point(-113.979, 66.184, 93.707),
    Jath::Point(-112.981, 67.918, 93.28),
    Jath::Point(-111.97, 69.643, 92.833),
    Jath::Point(-110.946, 71.361, 92.601),
    Jath::Point(-109.906, 73.07, 92.124),
    Jath::Point(-108.851, 74.769, 91.628),
    Jath::Point(-107.78, 76.458, 91.113),
    Jath::Point(-106.693, 78.137, 90.58),
    Jath::Point(-105.589, 79.804, 90.031),
    Jath::Point(-104.466, 81.459, 89.467),
    Jath::Point(-103.325, 83.102, 88.889),
    Jath::Point(-102.164, 84.73, 88.301),
    Jath::Point(-100.982, 86.344, 87.706),
    Jath::Point(-99.779, 87.941, 87.105),
    Jath::Point(-98.554, 89.522, 86.504),
    Jath::Point(-97.307, 91.085, 85.905),
    Jath::Point(-96.035, 92.629, 85.024),
    Jath::Point(-94.739, 94.152, 84.455),
    Jath::Point(-93.418, 95.654, 83.907),
    Jath::Point(-92.071, 97.132, 83.137),
    Jath::Point(-90.698, 98.586, 82.667),
    Jath::Point(-89.297, 100.014, 82.045),
    Jath::Point(-87.871, 101.416, 81.694),
    Jath::Point(-86.417, 102.789, 81.278),
    Jath::Point(-84.935, 104.133, 81.01),
    Jath::Point(-83.428, 105.447, 80.908),
    Jath::Point(-81.894, 106.73, 80.937),
    Jath::Point(-80.333, 107.981, 81.135),
    Jath::Point(-78.748, 109.201, 81.52),
    Jath::Point(-77.14, 110.389, 82.092),
    Jath::Point(-75.508, 111.546, 82.845),
    Jath::Point(-73.856, 112.673, 83.768),
    Jath::Point(-72.184, 113.77, 84.846),
    Jath::Point(-70.494, 114.839, 86.058),
    Jath::Point(-68.787, 115.882, 87.384),
    Jath::Point(-67.066, 116.901, 88.8),
    Jath::Point(-65.332, 117.897, 90.279),
    Jath::Point(-63.587, 118.874, 91.289),
    Jath::Point(-61.832, 119.833, 92.82),
    Jath::Point(-60.176, 120.955, 97.844),
    Jath::Point(-58.522, 122.079, 97.388),
    Jath::Point(-56.863, 123.196, 96.932),
    Jath::Point(-55.2, 124.307, 96.475),
    Jath::Point(-53.532, 125.411, 96.012),
    Jath::Point(-51.859, 126.506, 95.699),
    Jath::Point(-50.18, 127.592, 95.221),
    Jath::Point(-48.494, 128.669, 94.731),
    Jath::Point(-46.802, 129.735, 94.225),
    Jath::Point(-45.102, 130.789, 93.7),
    Jath::Point(-43.395, 131.831, 93.154),
    Jath::Point(-41.68, 132.86, 92.776),
    Jath::Point(-39.956, 133.874, 92.188),
    Jath::Point(-38.224, 134.873, 91.569),
    Jath::Point(-36.482, 135.856, 90.917),
    Jath::Point(-34.73, 136.821, 90.229),
    Jath::Point(-32.968, 137.768, 89.5),
    Jath::Point(-31.196, 138.694, 88.99),
    Jath::Point(-29.412, 139.598, 88.185),
    Jath::Point(-27.617, 140.48, 87.33),
    Jath::Point(-25.809, 141.336, 86.418),
    Jath::Point(-23.99, 142.166, 85.448),
    Jath::Point(-22.158, 142.968, 84.413),
    Jath::Point(-20.312, 143.739, 83.309),
    Jath::Point(-18.454, 144.478, 82.133),
    Jath::Point(-16.581, 145.181, 80.88),
    Jath::Point(-14.695, 145.846, 79.547),
    Jath::Point(-12.795, 146.47, 78.131),
    Jath::Point(-10.881, 147.051, 76.629),
    Jath::Point(-8.954, 147.585, 75.04),
    Jath::Point(-7.013, 148.068, 73.367),
    Jath::Point(-5.06, 148.496, 71.008),
    Jath::Point(-3.094, 148.866, 69.151),
    Jath::Point(-1.118, 149.173, 67.22),
    Jath::Point(0.876, 149.072, 74.931),
    Jath::Point(2.866, 148.881, 75.396),
    Jath::Point(4.852, 148.64, 75.86),
    Jath::Point(6.83, 148.347, 76.549),
    Jath::Point(8.801, 148.005, 77.001),
    Jath::Point(10.762, 147.616, 77.445),
    Jath::Point(12.714, 147.179, 78.095),
    Jath::Point(14.655, 146.697, 78.515),
    Jath::Point(16.584, 146.171, 78.923),
    Jath::Point(18.502, 145.602, 79.512),
    Jath::Point(20.406, 144.99, 79.887),
    Jath::Point(22.297, 144.338, 80.248),
    Jath::Point(24.173, 143.647, 80.595),
    Jath::Point(26.035, 142.916, 81.086),
    Jath::Point(27.882, 142.148, 81.394),
    Jath::Point(29.713, 141.344, 81.687),
    Jath::Point(31.528, 140.504, 82.096),
    Jath::Point(33.326, 139.628, 82.348),
    Jath::Point(35.107, 138.719, 82.585),
    Jath::Point(36.871, 137.777, 82.805),
    Jath::Point(38.618, 136.803, 83.105),
    Jath::Point(40.346, 135.796, 83.285),
    Jath::Point(42.056, 134.759, 83.449),
    Jath::Point(43.748, 133.692, 83.596),
    Jath::Point(45.42, 132.595, 83.787),
    Jath::Point(47.072, 131.468, 83.894),
    Jath::Point(48.705, 130.313, 83.984),
    Jath::Point(50.318, 129.131, 84.059),
    Jath::Point(51.911, 127.921, 84.14),
    Jath::Point(53.482, 126.683, 84.173),
    Jath::Point(55.031, 125.419, 84.19),
    Jath::Point(56.56, 124.13, 84.19),
    Jath::Point(58.066, 122.814, 84.158),
    Jath::Point(59.549, 121.472, 84.115),
    Jath::Point(61.01, 120.106, 84.055),
    Jath::Point(62.446, 118.714, 83.977),
    Jath::Point(63.859, 117.299, 83.827),
    Jath::Point(65.246, 115.858, 83.704),
    Jath::Point(66.609, 114.394, 83.562),
    Jath::Point(67.945, 112.906, 83.4),
    Jath::Point(69.255, 111.394, 83.121),
    Jath::Point(70.537, 109.859, 82.91),
    Jath::Point(71.791, 108.301, 82.677),
    Jath::Point(72.927, 106.838, 82.42),
    Jath::Point(72.927, 106.838, 0),
};
Jath::Path rings1Path = Jath::Path::cm(rings1Points);

void skills()
{

    smartDrive.m_pos = art::Vec2::XandY(art::Tiles(-2.5), art::Tiles(0.5));
    smartDrive.m_dir = art::Degrees(-135);
    ...
    followPathRev(pickup1Path, art::Inches(5));
    ...
    followPath(rings1Path, art::Inches(15));
