...
namespace sds {
	...
	std::unordered_map <std::string, std::string> Screen::m_data = {};
	...
	void Screen::setData(std::string key, std::string data)
	{
		m_data[key] = data;
	}

	std::string Screen::getData(std::string key)
	{
